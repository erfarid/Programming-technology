...
This project simulates a simplified version of the **Capitaly board ** using Java and Swing. The program demonstrates **object-oriented programming (OOP) concepts** such as inheritance, polymorphism, encapsulation, and strategy patterns.  
